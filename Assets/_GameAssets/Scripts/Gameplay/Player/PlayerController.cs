...
public class PlayerController : MonoBehaviour
{
    ...
    private void SetStates()
    {
        ...
        var currentState = _stateController.GetCurrrentState();
    ...
    private void SetPlayerMovement()
    {
        ...
        float forceMultiplier = _stateController.GetCurrrentState() switch
        {
            PlayerState.Move => 1f,
  ...
  _playerRigidbody.AddForce(_movementDirection.normalized * _movementSpeed * forceMultiplier, ForceMode.Force);
    ...
    {
        _playerRigidbody.linearDamping = _stateController.GetCurrrentState() switch
        {
